...
class BankAccountCreditCardPaymentMethodTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->card = Card::factory()->makeOne([ "mode" => "credit"  ] );
    ...
    public function test_bank_account_card_mode_credit_payment_method_listing(){
    ...
    public function test_bank_account_card_mode_credit_payment_method_api_listing(){
