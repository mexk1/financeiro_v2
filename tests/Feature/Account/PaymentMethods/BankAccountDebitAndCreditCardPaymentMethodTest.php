...
class BankAccountDebitAndCreditCardPaymentMethodTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->card = Card::factory()->makeOne([ "mode" => "both"  ] );
    ...
    public function test_bank_account_card_credit_and_debit_payment_method_listing(){
        ...
        $this->assertEquals([
            ...
            [ "origin" => "card", "mode" => "credit", "reference_id" => $this->card->id ],
        ], $methods );
    }

    public function test_bank_account_card_credit_and_debit_payment_method_api_listing(){
